...
description: Watermark configuration guide for xhs-image
---
...
| Inconsistent across images | Repeat the exact watermark instruction in every affected asset prompt |
